...
export const SECTION_HEADING_CLASS = "text-xl font-semibold tracking-tight";
...
export const HEADER_NAV = [
  { label: "Önizleme", target: "top" as const },
...
export function scrollToNavTarget(target: NavTarget, options?: { updateHistory?: boolean }) {
