...
import { DIYANET_HIJRI_ANCHORS } from "@/lib/hijri/diyanet-hijri-anchors";
import type { DianetHijriAnchor } from "@/lib/hijri/diyanet-hijri-anchors";
...
function resolveFromDiyanetAnchors(ah: number, hm: number, hd: number): GregorianParts | null {
...
export function hijriToGregorianParts(ah: number, hm: number, hd: number): GregorianParts {
...
export function turkeyTimestamptzRange(parts: GregorianParts): TurkeyTimestamptzRange {
