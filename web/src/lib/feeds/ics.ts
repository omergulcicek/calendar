...
function calendarEventToLines(event: CalendarEvent, hostname: string, dtStamp: string): string[] {
...
export function serializeCalendarFeed(events: CalendarEvent[], calName: string): string {
...
export function buildFeedFilename(categorySlugs: string[] | "all"): string {
